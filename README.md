# Code and models for: _Learning Personalized Models of Human Behavior in Chess_
...
We have included 4 sample models, selected at random, from our holdout set the 398 player. As well as the final 3 models for the players discussed in the supplement. `sample-1900` is the final model for the player the numbers are given for.

We also include the maia model, from [https://github.com/CSSLab/maia-chess](https://github.com/CSSLab/maia-chess) that was used as the base.
